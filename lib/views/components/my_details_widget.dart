...
class MyDetailsWidget extends StatelessWidget {
  const MyDetailsWidget(
      {Key? key,
      this.height = 800,
      this.isMobile = false,
      this.paddingValue = 60})
      : super(key: key);
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text("This design is from dribbble. ",
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        String designUrl =
                            "https://dribbble.com/shots/16367386-ALEX-Freelancer-Portfolio-Web-Design";
                        launchUrl(designUrl);
                      },
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("//region ABOUT ME",
                          style: AppTheme.textTheme.bodyText1.copyWith(
                              fontWeight: FontWeight.bold,
                              color: colorGreyText)),
                      Expanded(child: SizedBox()),
                      Text(
                        "I am mobile application developer with over 7 years of work experience. 4 Years in Android, 3 Years in Flutter.",
